...
class TrainDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        target = Image.open(self.gt_list[index]).convert('L')
...
def get_train_datasets(csv_path_train, tg_size=(512, 512), label_values=(0, 255)):
...
def get_train_loaders(csv_path_train, batch_size=4, tg_size=(512, 512), label_values=(0, 255), num_workers=0):
    train_dataset = get_train_datasets(csv_path_train, tg_size=tg_size, label_values=label_values)
